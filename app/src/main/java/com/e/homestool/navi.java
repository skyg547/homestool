...
public class navi extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.contianer2,airtoolFragment).commit();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_0) {
            ...
            Toast.makeText(this, "2번쨰 메뉴 선택됨", Toast.LENGTH_LONG).show();
        } else if (id == R.id.nav_2) {

            Toast.makeText(this, "3번쨰 메뉴 선택됨", Toast.LENGTH_LONG).show();
        }
